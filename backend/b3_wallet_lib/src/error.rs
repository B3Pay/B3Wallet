...
impl TrapError for SignerError {
    fn to_string(self) -> String {
        match self {
            ...
            SignerError::RequestNotFound(msg) => ["Request not found: ", &msg.to_string()].concat(),
            ...
            SignerError::AlreadySigned(signer) => ["Signer ", &signer, " already signed"].concat(),
            ...
            SignerError::WalletAccountNotExists => "Wallet account does not exist!".to_string(),
