...
impl fmt::Display for OperationError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ...
            OperationError::UserNotAllowed(ref msg) => write!(f, "{} is not allowed to perform this operation!", msg),
            OperationError::UserNotFound(ref msg) => write!(f, "{} is not a user!", msg),
            ...
            OperationError::RequestAlreadySigned(ref user) => write!(f, "User {} already signed", user),
