...
impl fmt::Display for AppSystemError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ...
            AppSystemError::BugsNotFound => write!(f, "Bugs not found!"),
            AppSystemError::BugNotFound => write!(f, "Bug not found!"),
            AppSystemError::UserNotFound => write!(f, "User not found!"),
            ...
            AppSystemError::ProductAlreadyExists => write!(f, "Product already exists!"),
