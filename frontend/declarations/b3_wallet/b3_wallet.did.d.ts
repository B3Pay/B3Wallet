...
export type Operations = { 'UnhideAccount' : HideAccount } |
...
export type Result = { 'Ok' : bigint } |
  { 'Err' : string };
export type Result_1 = { 'Ok' : ProcessedRequest } |
  { 'Err' : string };
...
export type SignerRoles = { 'User' : null } |
  { 'Canister' : null } |
  { 'Admin' : null };
...
export interface _SERVICE {
  ...
  'process_request' : ActorMethod<[bigint], undefined>,
  ...
  'request_delete_account' : ActorMethod<
    ...
    bigint
  >,
  'request_maker' : ActorMethod<[Operations, string, [] | [bigint]], bigint>,
  ...
  'signer_add' : ActorMethod<
    [Principal, SignerRoles],
    Array<[Principal, Signer]>
  >,
